function init() {
  ...
  var tweetOverlayForm = document.getElementById("new-tweet-form");
  tweetOverlayForm.addEventListener("submit", function(evt) {
    evt.preventDefault();

    var text = document.getElementById("new-tweet-text").value;
  ...
  var tweetOverlayCancel = document.getElementById("cancel-button");
